#! /usr/bin/env python3
"""T75 readiness court (python isle): the BATTERY/THERMAL device-evidence ingest machinery.
...
def device_result(gate, **overrides):
    ...
    document = {
        ...
        "evidence": {
            ...
            "operator_role": "T75-FIXTURE operator (rehearsal -- not a real operator)",
            "result_sha256": "a" * 64,
            "executor": "T75-FIXTURE executor (rehearsal)",
