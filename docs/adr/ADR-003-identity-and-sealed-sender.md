...
- **Phase C8.4D1 Persistent Duplex BLE Link Substrate:**
  ...
  - **C8.4D1-R2 Substrate Implementation & Closure:** OPEN (production-integrated orchestration drivers, delivery retirement held-set notification, server callback epoch poisoning, pure ATT cache reads, semantic mutation controls, and Apple CoreBluetooth background-discovery limitation explicit).
