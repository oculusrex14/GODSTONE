...
**STATUS: ACCEPTED / PHASE C8.4C RECORD LAYER FROZEN; PHASE C8.4D1-A1 LINKINFO AMENDMENT ACCEPTED / FROZEN; PHASE C8.4D1-R2 IMPLEMENTED / FROZEN** (28 Aug 2026)
Implementation:
...
- Phase C8.4D1-R2 (Implementation of LinkInfo exchange, Android GATT lifecycle repairs, and substrate closure) is IMPLEMENTED and FROZEN.
