...
SEMANTIC = [
    ...
    {'id': 'T38-RC1-ios-zero-seal-sails-through', 'platform': 'swift', 'file': 'ios/Godstone/Sources/GodstoneMesh/SignedSosV1.swift', 'find': 'else { return .refuse(.signature) }', 'replace': 'else { }', 'why': 'the final cryptographic gate authenticates vacuously on the iOS twin: the all-zero signature slot of the structural fixture -- and any forged seal whatsoever -- sails through to authenticated; the section-15 split is what the court kills', 'witness': 'testRuntimeRejectsZeroSignatureStructuralFixture', 'swift_filter': 'ReadinessT38Tests'},
