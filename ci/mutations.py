...
SEMANTIC = [
    ...
    {"id": "T52-SM25-gates-alarm-sleepeth", "platform": "python", "file": "ci/check_release_gates_status.py", "court": "tools/readiness/tests/test_t52.py", "py_dir": "tools/readiness/tests", "py_pattern": "test_t52.py", "find": "    if failed:\n", "replace": "    if False:\n", "why": "the selftest that seeth the twelve controls and returneth nought is the false friend of the release; the alarm sleepeth and the lie 'refuseth 12 of 12' is told", "witness": "testTheGatesCheckerRefusethAllTwelveByName"},
    {"id": "T52-SM26-evidence-shape-widened", "platform": "python", "file": "ci/check_release_gates_status.py", "court": "tools/readiness/tests/test_t52.py", "py_dir": "tools/readiness/tests", "py_pattern": "test_t52.py", "find": "            if not isinstance(ev, str) or not re.fullmatch(r\"[0-9a-f]{40}\", ev) or ev == \"0\" * 40:\n", "replace": "            if not isinstance(ev, str) or not re.fullmatch(r\".{40}\", ev) or ev == \"0\" * 40:\n", "why": "a CLOSED gate's evidence is a full lowercase SHA; widened to any forty bytes, the forged 'yes'-like witness is no more refused", "witness": "testTheGatesCheckerRefusethAllTwelveByName"},
    {"id": "T52-SM27-wiring-first-blind", "platform": "python", "file": "ci/check_content_release_integration.py", "court": "tools/readiness/tests/test_t52.py", "py_dir": "tools/readiness/tests", "py_pattern": "test_t52.py", "find": "    if missing:\n", "replace": "    if False:\n", "why": "the release builder wired to the content gate is the first face; blind, the checker counteth 0 of 3 and the print swelleth the lie", "witness": "testTheIntegrationCheckerCountethItsFacesTruthfully"},
    {"id": "T52-SM28-presence-faces-unseen", "platform": "python", "file": "ci/check_content_release_integration.py", "court": "tools/readiness/tests/test_t52.py", "py_dir": "tools/readiness/tests", "py_pattern": "test_t52.py", "find": "    if absent:\n", "replace": "    if False:\n", "why": "the nineteen presence faces are the contract struck against the inspector; unseen, the checker witnesseth '19 of 19' over an emptied file", "witness": "testTheIntegrationCheckerCountethItsFacesTruthfully"},
]
