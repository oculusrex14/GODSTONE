...
final class ProofOfWorkTests: XCTestCase {
    ...
    private var katNonce20: Data { data(fromHex: "00000000000f7ca6") }
    private let katDigest20 = "00000a423fecc011777adba990e5b1bf0556b1e5ab81b1c9028bdf020c4348a5"

    // pow_8bit_message_help: same inputs, target 8 bits.
    private var katNonce8: Data { data(fromHex: "0000000000000038") }
    private let katDigest8 = "0084658c84b1a33256d27a4414839a3fee2562948aaea88ab692dd747d620d1a"
