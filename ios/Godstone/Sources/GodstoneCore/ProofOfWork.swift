...
// android/.../router/ProofOfWork.kt. Stage 3 Phase C / Stage 4 C6.7.2 pins both runtimes to the
...
/// payload (ADR-001 §3, C6.7.2). Under GMP/2.1 msg_id is a content hash and cannot be
